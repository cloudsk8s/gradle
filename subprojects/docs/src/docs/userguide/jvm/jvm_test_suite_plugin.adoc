...
// use subprojects/docs/src/snippets/developingPlugins/pluginWithVariants/groovy/build.gradle and
// subprojects/docs/src/docs/userguide/developing-plugins/implementing_gradle_plugins.adoc as example for numeric callouts
